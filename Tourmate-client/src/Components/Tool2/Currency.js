...
const Currency = ({ currencyDetails, setCurrencyDetails, countryDetails }) => {
  ...
  const handleCurrencyConvert = (e) => {
    ...
    axios
      .get(
        `https://api.apilayer.com/exchangerates_data/convert?to=EGP&from=${countryDetails?.currency_code}&amount=${amount}`,
        { headers: myHeaders }
      )
      .then((response) => {
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    disabled
                  >
                    <option value="EGP">{countryDetails?.currency_code}</option>
                  </select>
                </div>
              </div>
              <div>
